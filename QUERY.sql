...
where full_name like 'T%' or full_name ilike '%Haque%';
...
select users.user_id, users.full_name,bookings.booking_id from users left join bookings on bookings.user_id = users.user_id;
